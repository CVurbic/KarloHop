        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href={getHashHref("#pocetna")} className="text-background/80 hover:text-white transition-colors">
                  Početna
                </a>
              </li>
              <li>
                <a href={getHashHref("#napuhanci")} className="text-background/80 hover:text-white transition-colors">
                  Napuhanci
                </a>
              </li>
              <li>
                <a href={getHashHref("#prednosti")} className="text-background/80 hover:text-white transition-colors">
                  Prednosti
                </a>
              </li>
              <li>
                <a href={getHashHref("#rezervacija")} className="text-background/80 hover:text-white transition-colors">
                  Rezervacija
                </a>
              </li>
              <li>
                <a href={getHashHref("#kontakt")} className="text-background/80 hover:text-white transition-colors">
                  Kontakt
                </a>
              </li>
              <li>
