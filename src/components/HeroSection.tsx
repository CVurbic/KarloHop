      ...
      <div className="container mx-auto px-4 relative z-10 bg-transparent">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left text-white">
            <h1 className="text-5xl font-bold mb-6 leading-tight text-gray-800 lg:text-8xl">
              Hop Hop
              <br />
              <span className="text-warning">Napuhanci</span>
            </h1>
          ...
          <div className="flex justify-center lg:justify-end">
            <img src="/assets/mascot-jumping-new.png" alt="Hop Hop Mascot jumping with kids on bounce house" className="w-full max-w-md lg:max-w-lg xl:max-w-xl h-auto hop-bounce" />
          </div>
        </div>
      </div>
